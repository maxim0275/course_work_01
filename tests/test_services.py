...
class TestServices(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = pd.DataFrame(
            {
                "Дата платежа": ["05.12.2021", "15.12.2021", "20.11.2021", "20.12.2021"],
                "Категория": ["Food", "Electronics", "Food", "Transport"],
                "Кэшбэк": [100.0, 150.0, 50.0, 200.0],
                "Статус": ["OK", "OK", "Canceled", "OK"],
            }
        )

        # Ожидаемый результат
        self.expected_result = {"Transport": 200.0, "Electronics": 150.0, "Food": 100.0}
