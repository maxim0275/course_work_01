...
@pytest.mark.parametrize(
    "expected", [[{"cashback": "5.00", "last_digits": "xxx-xxxx-xxxx-5678", "total_spent": "500.00"}]]
)
...
@pytest.mark.parametrize("expected", [[{"currency": "USD", "rate": 74.0}, {"currency": "EUR", "rate": 85.5}]])
...
@pytest.mark.parametrize("expected", [[{"stock": "AAPL", "price": 145.3}, {"stock": "GOOGL", "price": 2734.5}]])
